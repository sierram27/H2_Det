...
def znd_plot(znd_output,xscale='linear',maxx=None, species_min=None,
             major_species=None,minor_species=None,show=True):
    """
    ...
    OPTIONAL INPUT:
        ...
        maxx: Maximum distance to plot to on the x-axis. By default, determined internally.
        
        show: Whether to display the figures. Defaults to 'True', but can set to 'False'
              if the user wants to return the figure handles to make further modifications
              before displaying.

        species_min: minimum mole fraction on species plot, default is 1E-8
